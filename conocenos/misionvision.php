...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Misión</h4>
				<p class="derecha-p">
					“Fortalecer la CAPEMA y Asociados, Desarrollando las capacidades locales de los mismos en los temas de
					Producción, comercialización, Gestión Empresarial, y equidad de Género lográndose la Sostenibilidad
					Social, Económica y Ambiental”.
				</p>

				<h4 class="derecha-h4">Visión</h4>
				<p class="derecha-p">
					“Ser una Cooperativa consolidada y líder, en la Producción Sostenible de productos agropecuarios de alta calidad, 
					para ofertar a los mercados nacionales e internacionales”
				</p>
