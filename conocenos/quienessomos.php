...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Quienes Somos</h4>
				<p class="derecha-p">
					CAPEMA, Nace como asociación en el año 2007, como una alternativa de desarrollo 
					integral de pequeños productores de café localizados en el Valle Huasta en la Margen 
					Izquierda del Rio Mayo y en la cuenca del Rio Yuracyacu en la Margen Derecha del Rio
					Mayo en el departamento de San Martin – Perú.; con la finalidad de brindar mejores 
					servicios a nuestros asociados nos convertimos en el año 2011 en Cooperativa. 
					En la actualidad agrupamos a 233 familias cafetaleras.
				</p>
