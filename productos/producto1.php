...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Café tostado molido</h4>
				<p class="derecha-p">
					CAFÉ “EL SHAPINGO”.Es un producto producido por agricultores que
					mediante prácticas amigables contribuyen el cuidado y conservación del Medio Ambiente.
				</p>
