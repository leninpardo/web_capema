			...
			<nav class="menuContainer">
				...
				<ul class="nav menuContainer-lista">
					...
					<li class="menuContainer-item"><a href="../index.php" class="menuContainer-link">PRODUCTOS</a>
						<ul class="menuContainer-lista submenu">
							<li class="menuContainer-item1"><a class="menuContainer-link" href="producto1.php">Café tostado molido</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="producto2.php">Abonos orgánicos</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="producto3.php">Abonos foliares</a></li>
						</ul>
					</li>
		...
		<div class="principal">
			<div class="izquierda">
				...
				<ul class="izquierda-lista">
					<li class="izquierda-item"><a class="izquierda-link" href="producto1.php">Café EL SHAPINGO</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="producto2.php">EL BOCASHI</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="producto3.php">Abonos foliares</a></li>
				</ul>
			</div>
			<div class="derecha">
				<h4 class="derecha-h4">Abonos orgánicos</h4>
				<p class="derecha-p">
					EL BOCASHI Es todo material que se obtiene de la degradación y mineralización de materiales orgánicos que proviene directa e indirectamente de las plantas y animales; que se obtiene en sacos de 50 kg para su comercialización.
				</p>
				<div class="derecha-img">
					<img src="../img/producto1.png" width="200" alt="" >
				</div>
			</div>
		</div>
