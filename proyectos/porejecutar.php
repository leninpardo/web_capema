			...
			<nav class="menuContainer">
				...
				<ul class="nav menuContainer-lista">
					...
					<li class="menuContainer-item"><a href="../index.php" class="menuContainer-link">PROYECTOS</a>
						<ul class="menuContainer-lista submenu">
							<li class="menuContainer-item1"><a class="menuContainer-link" href="ejecutados.php">Ejecutados</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="porejecutar.php">Por ejecutar</a></li>
						</ul>
					</li>
		...
		<div class="principal">
			<div class="izquierda">
				...
				<ul class="izquierda-lista">
					<li class="izquierda-item"><a class="izquierda-link" href="ejecutados.php">Ejecutados</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="porejecutar.php">Por ejecutar</a></li>
				</ul>
			</div>
			<div class="derecha">
				<h4 class="derecha-h4">Proyecto Juvenil de Negocios</h4>
				<p class="derecha-p">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus placeat voluptates saepe minima. Voluptate quidem quo reiciendis vel odio ea, sapiente mollitia fuga, libero vero autem quis sunt necessitatibus asperiores.
				</p>
				<h4 class="derecha-h4">Crianza de Peces</h4>
				<p class="derecha-p">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus placeat voluptates saepe minima. Voluptate quidem quo reiciendis vel odio ea, sapiente mollitia fuga, libero vero autem quis sunt necessitatibus asperiores.
				</p>
			</div>
