...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Desarrollo organizacional y de capacidades de los Productores: </h4>
				<p class="derecha-p">
					Orientado a lograr la identificación y fidelización de los asociados con su Cooperativa. Ademas desarrolla temas de  capacitación dirigida a los directivos y asociados de la Cooperativa.
				</p>
