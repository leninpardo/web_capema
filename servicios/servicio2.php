...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Mejoramiento de la calidad y productividad: </h4>
				<p class="derecha-p">
					Orientado a la adopción de prácticas técnico productivas que permitan 
					lograr un producto de alta calidad y en concordancia con el medio ambiente.
				</p>
