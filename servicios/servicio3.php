			...
			<nav class="menuContainer">
				...
				<ul class="nav menuContainer-lista">
					...
					<li class="menuContainer-item"><a href="../index.php" class="menuContainer-link">SERVICIOS</a>
						<ul class="menuContainer-lista submenu">
							<li class="menuContainer-item1"><a class="menuContainer-link" href="servicio1.php">Desarrollo organizacional y de capacidades de los Productores</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="servicio2.php">Mejoramiento de la calidad y productividad</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="servicio3.php">Fortalecimiento de la familia y género</a></li>
							<li class="menuContainer-item1"><a class="menuContainer-link" href="servicio4.php">Talleres de educación ambiental</a></li>
						</ul>
					</li>
		...
		<div class="principal">
			<div class="izquierda">
				...
				<ul class="izquierda-lista">
					<li class="izquierda-item"><a class="izquierda-link" href="servicio1.php">Desarrollo Organizacional</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="servicio2.php">Mejoramiento de calidad</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="servicio3.php">Fortalecimiento de familia</a></li>
					<li class="izquierda-item"><a class="izquierda-link" href="servicio4.php">Talleres</a></li>
				</ul>
			</div>
			<div class="derecha">
				<h4 class="derecha-h4">Fortalecimiento de la familia y género: </h4>
				<p class="derecha-p">
					Orientado al reconocimiento del trabajo familiar y la búsqueda de alternativa de 
					desarrollo económico de las familias cafetaleras, para ello la CAPEMA viene implementando 
					e instalando biohuertos familiares de hortalizas, con la finalidad de mejorar la dieta 
					alimenticia de la familia. También se está instalando módulos de crianza de cuyes, módulo de 
					gallinas ponedoras, todo ello como actividad del componente de seguridad alimentaria que la 
					Cooperativa viene desarrollando.
				</p>
