...
<body>
	<div class="principalContainer">
		...
		<div class="principal">
			...
			<div class="derecha">
				<h4 class="derecha-h4">Talleres de educación ambiental: </h4>
				<p class="derecha-p">
					Desarrollado a nivel de las escuelas de los caseríos del ambiento de acción de CAPEMA, 
					Dirigido a los niños del 1° al 3° año de educación primaria con el objetivo de propiciar y 
					educar a los pobladores en el cuidado y conservación del medio ambiente.
				</p>
